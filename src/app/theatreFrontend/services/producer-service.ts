...
export class ProducerService {
  private _url = 'http://localhost:8080/api/v1/addTheatre';
  private _url2 = 'http://localhost:8080/api/v1/deleteTheatre';
  private _url1 = 'http://localhost:8080/api/v1/producer';
